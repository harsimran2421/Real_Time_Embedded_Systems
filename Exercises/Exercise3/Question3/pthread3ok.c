//Modification Made in Dr Sam Stiewert's Code
#include <pthread.h>
#include <stdio.h>
#include <sched.h>
#include <time.h>
...
void *idle(void *threadid)
{
  ...
  printf("**** %d idle stopping at %d sec, %d nsec\n", (int)threadid, timeNow.tv_sec, timeNow.tv_usec);
