 ...
 * *     -main
 * *
 * *THIS CODE CONTAINS CODE FROM Dr SAM SIEWERT'S EXAMPLE.
 * *
 * *
...
int main(void)
{
   ...
   printf("Ex-6(Deadline Monotonic) U=%4.2f (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7, T4=13; D1=2, D2=3, D3=7, D4 =15): ",
  ...
  printf("Ex-8 U=%4.4f (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7, T4=13; T=D): ",
		   ((1.0/2.0) + (1.0/5.0) + (1.0/7.0) + (2.0/13.0)));
