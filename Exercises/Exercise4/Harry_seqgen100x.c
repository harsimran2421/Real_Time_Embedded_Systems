...
// Service_7 - 100 Hz, every 300th Sequencer loop
...
float deadline_s1 = 3.33;
float deadline_s2 = 10;
float deadline_s3 = 20;
float deadline_s4 = 10;
float deadline_s5 = 20;
float deadline_s6 = 10;
float deadline_s7 = 100;
...
void *Service_1(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s1 = 0;  //to store worst case execution time 
    unsigned long long total_exe_time_s1 = 0;     // to calcuate average execution time
    unsigned long long exe_time_s1 = 0;           //to store execution time for each instance
    unsigned long long avrge_exe_time_s1 = 0;     
    threadParams_t *threadParams = (threadParams_t *)threadp;
    ...
    while(!abortS1)
    {
        ...
        exe_time_s1 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000); //calculate the execution time in nano seconds

        /*condition to calculate the worst case execution time for case 1*/
        if(exe_time_s1 > wrst_cse_exe_time_s1)
        {
          wrst_cse_exe_time_s1 = exe_time_s1;
        }
        total_exe_time_s1 = total_exe_time_s1 + exe_time_s1;
    }
    avrge_exe_time_s1 = total_exe_time_s1/S1Cnt;   // to calculate the average time of execution
    printf("\nRM Analysis for service 1\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s1,avrge_exe_time_s1, deadline_s1);
    pthread_exit((void *)0);
}
...
void *Service_2(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s2 = 0; //to store worst case execution time value
    unsigned long long total_exe_time_s2 = 0;    // to calculate average execution time
    unsigned long long exe_time_s2 = 0;          // to store execution time for each instance
    unsigned long long avrge_exe_time_s2 = 0;
    ...
    while(!abortS2)
    {
        ...
        exe_time_s2 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000); //calculate execution time in nano seconds
        /*condition to calculate the worst case execution time for case 2*/
        if(exe_time_s2 > wrst_cse_exe_time_s2)
        {
          wrst_cse_exe_time_s2 = exe_time_s2;
        }
        total_exe_time_s2 = total_exe_time_s2 + exe_time_s2;
    }
    avrge_exe_time_s2 = total_exe_time_s2/S2Cnt;  //calculate the average execution time
    printf("\nRM Analysis for service 2\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s2,avrge_exe_time_s2, deadline_s2);
...
void *Service_3(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s3 = 0;
    unsigned long long total_exe_time_s3 = 0;
    unsigned long long exe_time_s3 = 0;
    unsigned long long avrge_exe_time_s3 = 0;
    threadParams_t *threadParams = (threadParams_t *)threadp;
    ...
    while(!abortS3)
    {
        ...
        exe_time_s3 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000); // calculate execution time in nano seconds
        /*condition to calculate the worst case execution time for case 3*/
        if(exe_time_s3 > wrst_cse_exe_time_s3)
        {
          wrst_cse_exe_time_s3 = exe_time_s3;
        }
        total_exe_time_s3 = total_exe_time_s3 + exe_time_s3;
    }
    avrge_exe_time_s3 = total_exe_time_s3/S3Cnt;   // to calculate the average execution time
    printf("\nRM Analysis for service 3\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s3,avrge_exe_time_s3, deadline_s3);
...
void *Service_4(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s4 = 0;   // to store the worst case execution time
    unsigned long long total_exe_time_s4 = 0;
    unsigned long long exe_time_s4 = 0;
    unsigned long long avrge_exe_time_s4 = 0; 
    threadParams_t *threadParams = (threadParams_t *)threadp;
    ...
    while(!abortS4)
    {
        ...
        exe_time_s4 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000);
        /*condition to calculate the worst case execution time for case 4*/
        if(exe_time_s4 > wrst_cse_exe_time_s4)
        {
          wrst_cse_exe_time_s4 = exe_time_s4;
        }
        total_exe_time_s4 = total_exe_time_s4 + exe_time_s4;
    }
    avrge_exe_time_s4 = total_exe_time_s4/S4Cnt;  //to calculate the average execution time
    printf("\nRM Analysis for service 4\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s4,avrge_exe_time_s4, deadline_s4);
...
void *Service_5(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s5 = 0;   // to store the worst case excution time 
    unsigned long long total_exe_time_s5 = 0;
    unsigned long long exe_time_s5 = 0;
    unsigned long long avrge_exe_time_s5 = 0;
    ...
    while(!abortS5)
    {
        ...
        exe_time_s5 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000);
        
        /*to update the worst case execution time*/
        if(exe_time_s5 > wrst_cse_exe_time_s5)
        {
          wrst_cse_exe_time_s5 = exe_time_s5;
        }
        total_exe_time_s5 = total_exe_time_s5 + exe_time_s5;
    }
    avrge_exe_time_s5 = total_exe_time_s5/S5Cnt;   // to calculate the average execution time
    printf("\nRM Analysis for service 5\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s5,avrge_exe_time_s5, deadline_s5);
...
void *Service_6(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s6 = 0;
    unsigned long long total_exe_time_s6 = 0;
    unsigned long long exe_time_s6 = 0;
    unsigned long long avrge_exe_time_s6 = 0;
    ...
    while(!abortS6)
    {
        ...
        exe_time_s6 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000);

        /*condition to calculate the worst case execution time for case 6*/
        if(exe_time_s6 > wrst_cse_exe_time_s6)
        {
          wrst_cse_exe_time_s6 = exe_time_s6;
        }
        total_exe_time_s6 = total_exe_time_s6 + exe_time_s6;
    }
    avrge_exe_time_s6 = total_exe_time_s6/S6Cnt;    // to calcualte the average execution time
    printf("\nRM Analysis for service 6\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s6,avrge_exe_time_s6, deadline_s6);
...
void *Service_7(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s7 = 0;
    unsigned long long total_exe_time_s7 = 0;
    unsigned long long exe_time_s7 = 0;
    unsigned long long avrge_exe_time_s7 = 0;
    ...
    while(!abortS7)
    {
        ...
        exe_time_s7 = (end_time_val.tv_sec*1000000000 - start_time_val.tv_sec*1000000000) + (end_time_val.tv_usec*1000 - start_time_val.tv_usec*1000);

        /*condition to calculate the worst case execution time for case 1*/
        if(exe_time_s7 > wrst_cse_exe_time_s7)
        {
          wrst_cse_exe_time_s7 = exe_time_s7;
        }
        total_exe_time_s7 = total_exe_time_s7 + exe_time_s7;
    }
    avrge_exe_time_s7 = total_exe_time_s7/S7Cnt;    // to calculate the average execution time
    printf("\nRM Analysis for service 7\t worst case execution time = %lldns Average execution time = %lldns deadline = period = %fms\n", wrst_cse_exe_time_s7,avrge_exe_time_s7, deadline_s7);
