...
float deadline_s1 = 333.33;
float deadline_s2 = 1000;
float deadline_s3 = 2000;
float deadline_s4 = 1000;
float deadline_s5 = 2000;
float deadline_s6 = 1000;
float deadline_s7 = 10000;
...
void *Service_7(void *threadp)
{
    ...
    printf("\nRM Analysis for service 7\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %fms\n", wrst_cse_exe_time_s7,avrge_exe_time_s7, deadline_s7);
