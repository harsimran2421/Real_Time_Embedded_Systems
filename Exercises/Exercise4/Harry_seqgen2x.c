...
double deadline_s1 = 33.33;
double deadline_s2 = 100;
double deadline_s3 = 200;
double deadline_s4 = 100;
double deadline_s5 = 200;
double deadline_s6 = 100;
double deadline_s7 = 1000;
...
void *Service_1(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s1 = 0;
    unsigned long long total_exe_time_s1 = 0;
    unsigned long long exe_time_s1 = 0;
    ...
    while(!abortS1)
    {
        ...
        exe_time_s1 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s1 = total_exe_time_s1/S1Cnt;
    printf("\nRM Analysis for service 1\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s1,avrge_exe_time_s1, deadline_s1);
    pthread_exit((void *)0);
}
...
void *Service_2(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s2 = 0;
    unsigned long long total_exe_time_s2 = 0;
    unsigned long long exe_time_s2 = 0;
    ...
    while(!abortS2)
    {
        ...
        exe_time_s2 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s2 = total_exe_time_s2/S2Cnt;
    printf("\nRM Analysis for service 2\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s2,avrge_exe_time_s2, deadline_s2);
...
void *Service_3(void *threadp)
{
    ...
    while(!abortS3)
    {
        ...
        exe_time_s3 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s3 = total_exe_time_s3/S3Cnt;
    printf("\nRM Analysis for service 3\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s3,avrge_exe_time_s3, deadline_s3);
...
void *Service_4(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s4 = 0;
    ...
    while(!abortS4)
    {
        ...
        exe_time_s4 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s4 = total_exe_time_s4/S4Cnt;
    printf("\nRM Analysis for service 4\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s4,avrge_exe_time_s4, deadline_s4);
...
void *Service_5(void *threadp)
{
    ...
    unsigned long long wrst_cse_exe_time_s5 = 0;
    ...
    while(!abortS5)
    {
        ...
        exe_time_s5 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s5 = total_exe_time_s5/S5Cnt;
    printf("\nRM Analysis for service 5\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s5,avrge_exe_time_s5, deadline_s5);
...
void *Service_6(void *threadp)
{
    ...
    while(!abortS6)
    {
        ...
        exe_time_s6 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s6 = total_exe_time_s6/S6Cnt;
    printf("\nRM Analysis for service 6\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s6,avrge_exe_time_s6, deadline_s6);
...
void *Service_7(void *threadp)
{
    ...
    while(!abortS7)
    {
        ...
        exe_time_s7 = (end_time_val.tv_sec*1000000 - start_time_val.tv_sec*1000000) + (end_time_val.tv_usec - start_time_val.tv_usec);
    ...
    avrge_exe_time_s7 = total_exe_time_s7/S7Cnt;
    printf("\nRM Analysis for service 7\t worst case execution time = %lldus Average execution time = %lldus deadline = period = %ldms\n", wrst_cse_exe_time_s7,avrge_exe_time_s7, deadline_s7);
